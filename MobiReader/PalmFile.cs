...
namespace MobiReader
{
    ...
    public class PalmFile
    {
        ...
        protected String m_Name;  // Database Name
        internal UInt32 m_Attributes;  // bit field.
        protected UInt32 m_Version; // File Version
        protected DateTime m_CreationDate; // Creation Date
        protected DateTime m_ModificationDate; // Modification Date
        protected DateTime m_LastBackupDate; // Last Backup Date
